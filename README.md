...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-87oifyk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-87oifyk.containers.anotherwebservice.com/
...
```
git clone git@github.com:danielruul78/container-87oifyk.git
cd container-87oifyk
```
...
```
docker attach container-87oifyk
```
